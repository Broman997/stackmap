  ...
  return (
    ...
    >
      ...
      <div className="flex flex-wrap justify-end gap-2">
        ...
        <button type="submit" disabled={tools.length === 0} className="rounded-md bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 disabled:cursor-not-allowed disabled:bg-slate-400">
          Save Subscription
        </button>
      </div>
    </form>
