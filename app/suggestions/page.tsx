      ...
      <section className="space-y-3">
        {suggestions.map((suggestion) => {
          ...
          <article key={suggestion.id} className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <div className="flex flex-wrap items-start justify-between gap-3">
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <button
                  ...
                  disabled={!canMerge}
                  className="inline-flex items-center gap-2 rounded-md border border-indigo-200 px-3 py-2 text-sm font-medium text-indigo-700 hover:bg-indigo-50 disabled:cursor-not-allowed disabled:border-slate-200 disabled:text-slate-300"
            ...
            {canMerge ? (
              <div className="mt-3 grid gap-2 rounded-md border border-indigo-100 bg-indigo-50 p-3">
                <label className="grid gap-1 text-sm font-medium text-indigo-950">
                  ...
                  <select
                    ...
                    className="rounded-md border border-indigo-200 bg-white px-3 py-2 font-normal text-slate-800"
                  >
